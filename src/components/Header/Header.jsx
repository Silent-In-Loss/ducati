...
const Header = () => {
  ...
  const [prevSlideImage, setPrevSlideImage] = useState('/moto2.png'); 
  const swiperRef = useRef(null);

  const slides = [
    { id: 1, title: 'DUГATI', img: '/moto1.png', details: '215 CV, 300 km/h, NPX 25/30' },
